    ...
    constructor: ->
        ...
        add_sub.sub.act.push 
            ...
            fun: ( evt, app ) =>
                ...
                p = new_popup "New attribute", event: evt, child: container_global, top_x: Pleft, top_y: Ptop, width: Pwidth, height: Pheight, onclose: =>
                    @onPopupClose( app )
        ...
        add_sub.sub.act.push 
            ...
            fun: ( evt, app ) =>
                ...
                p = new_popup "New TreeItem", event: evt, child: container_global, top_x: Pleft, top_y: Ptop, width: Pwidth, height: Pheight, onclose: =>
                    @onPopupClose( app )
                app.active_key.set false          
